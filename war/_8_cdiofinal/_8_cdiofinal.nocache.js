...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "_8_cdiofinal" because\n';
  ...
  $wnd.__gwt_activeModules['_8_cdiofinal'] = {
    'moduleName' : '_8_cdiofinal',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/_8_cdiofinal.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['_8_cdiofinal'].superdevmode = true;

  var expectedSuffix = '/_8_cdiofinal.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + _8_cdiofinal + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:_8_cdiofinal';
  var devModeSessionKey = '__gwtDevModeSession:_8_cdiofinal';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/_8_cdiofinal/_8_cdiofinal.nocache.js';
  ...
  $wnd.__gwt_activeModules['_8_cdiofinal'].canRedirect = true;
  $wnd.__gwt_activeModules['_8_cdiofinal'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING _8_cdiofinal';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/_8_cdiofinal?user.agent=' + ua + '&_callback=' + callback;
