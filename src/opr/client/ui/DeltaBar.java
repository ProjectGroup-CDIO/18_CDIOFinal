...
public class DeltaBar extends Composite {
	...
	public DeltaBar(final MainView main){
		...
		layoutPanel.setWidgetLeftWidth(layoutPanel_1, s, Unit.PX, 2.0, Unit.PX);
		...
		layoutPanel.setWidgetLeftWidth(layoutPanel_2, e1, Unit.PX, 2.0, Unit.PX);
		...
		layoutPanel.setWidgetLeftWidth(layoutPanel_3, e2, Unit.PX, 2.0, Unit.PX);
